...
Laravel 12.x application using a custom opinionated framework fork (`deplox/laravel-framework`). PHP 8.4, monorepo structure with three local packages in `packages/`. DDEV-based development environment (`play.ddev.site`).
